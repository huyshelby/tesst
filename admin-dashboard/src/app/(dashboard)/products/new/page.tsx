            ...
            <TabsContent value="images" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="/pictures/iphone-15-pro-max.jpg" {...field} />
                        </FormControl>
                        <FormDescription className="text-xs">
                          URL hoặc đường dẫn tương đối từ thư mục public
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <div className="border-2 border-dashed rounded-lg p-12 text-center bg-gray-50 hover:bg-gray-100 transition-colors">
