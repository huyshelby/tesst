...
async function fetchApi(path) {
    let opts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { retryOn401 = true } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
async function tryRefresh() {
    const base = ("TURBOPACK compile-time value", "http://localhost:4000/api");
    const res = await fetch("".concat(base, "/auth/refresh"), {
        method: "POST",
        credentials: "include"
    });
    ...
    if (data === null || data === void 0 ? void 0 : data.accessToken) {
        (await __turbopack_context__.A("[project]/src/lib/token.ts [app-client] (ecmascript, async loader)")).setAccessToken(data.accessToken);
        return true;
    }
    return false;
}
...
async function login(email, password) {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchApi"])("/auth/login", {
        method: "POST",
        body: JSON.stringify({
            email,
            password
    ...
    const data = await res.json().catch(()=>({}));
    if (!res.ok) throw new Error((data === null || data === void 0 ? void 0 : data.message) || "Đăng nhập thất bại");
    // backend trả { accessToken, user }
    if (data.accessToken) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$token$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAccessToken"])(data.accessToken);
    return data;
}
async function register(payload) {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchApi"])("/auth/register", {
        method: "POST",
    ...
    const data = await res.json().catch(()=>({}));
    if (!res.ok) throw new Error((data === null || data === void 0 ? void 0 : data.message) || "Đăng ký thất bại");
    return data;
}
async function logout() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchApi"])("/auth/logout", {
            method: "POST"
        }, {
            retryOn401: false
        });
    } finally{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$token$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAccessToken"])(null);
    }
}
async function forgotPassword(email) {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchApi"])("/password/forgot", {
        method: "POST",
        body: JSON.stringify({
            email
        })
...
async function resetPassword(token, password) {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchApi"])("/password/reset", {
        method: "POST",
        body: JSON.stringify({
            token,
            password
    ...
    const data = await res.json().catch(()=>({}));
    if (!res.ok) throw new Error((data === null || data === void 0 ? void 0 : data.message) || "Không thể đặt lại mật khẩu");
}
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            ({
                "AuthProvider.useEffect": async ()=>{
                    try {
                        const me = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMe"])();
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[value]": ()=>({
                ...
                async login (email, password) {
                    const { user } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
                    setUser(user);
                },
                async register (payload) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["register"])(payload);
                // tuỳ chọn: auto login sau khi đăng ký
                },
                async logout () {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])();
                    setUser(null);
                }
            })
    }["AuthProvider.useMemo[value]"], [
...
_s1(AuthProvider, "toMAEfa0y2Y/qFyTEOMPzs9vbbY=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=_faaea3a5._.js.map