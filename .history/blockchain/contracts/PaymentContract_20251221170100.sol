...
contract PaymentContract is ReentrancyGuard, Ownable {
    ...
    // Supported tokens
    address public constant USDT_TOKEN = 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd; // BSC Testnet USDT
    address public constant USDC_TOKEN = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; // BSC Testnet USDC
    address public constant NATIVE_TOKEN = 0x0000000000000000000000000000000000000000; // BNB
    
    // Exchange rates (mock - in production, use oracle)
    uint256 public constant USDT_RATE = 25000; // 1 USDT = 25,000 VND
    uint256 public constant USDC_RATE = 25000; // 1 USDC = 25,000 VND
    uint256 public constant ETH_RATE = 850000000; // 1 ETH = 850,000,000 VND (mock)
    uint256 public constant BNB_RATE = 15000000; // 1 BNB = 15,000,000 VND (mock)
    ...
    /**
     * @dev Pay for order using native coin (BNB)
     * @param orderId Unique order identifier
     */
    ...
    function getExchangeRate(address token) external view returns (uint256) {
        ...
        if (token == NATIVE_TOKEN) return BNB_RATE;
        return 0;
    }
