                ...
                {order.cryptoAmount && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {order.cryptoAmount} {order.cryptoToken || "ETH"}
                    </span>
                  </div>
                )}
                {order.cryptoNetwork && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{order.cryptoNetwork}</span>
                  </div>
                )}
                {order.cryptoConfirmations && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">Confirmations:</span>
                    <span className="font-semibold">{order.cryptoConfirmations}</span>
                  </div>
                )}
              </div>
            </div>
