  ...
  return (
    <div className={cn("relative inline-block", className)}>
      ...
      <div className="relative group">
        {/* Avatar Circle */}
        <div className="relative w-24 h-24 rounded-full overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center shadow-lg ring-4 ring-gray-100">
          {preview ? (
            <Image
              src={preview}
