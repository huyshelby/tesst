...
export const BLOCKCHAIN_ENV = process.env.NEXT_PUBLIC_BLOCKCHAIN_ENV || "local"; // local, testnet, mainnet

// Contract configuration
export const PAYMENT_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PAYMENT_CONTRACT_ADDRESS || "";

// Network configurations
export const HARDHAT_LOCAL_CHAIN_ID = "0x7a69"; // 31337 in hex
export const BSC_TESTNET_CHAIN_ID = "0x61"; // 97 in hex
export const HARDHAT_LOCAL_RPC = "http://127.0.0.1:8545";
export const BSC_TESTNET_RPC = "https://data-seed-prebsc-1-s1.binance.org:8545/";

// Select chain ID and RPC based on environment
export const CHAIN_ID = BLOCKCHAIN_ENV === "local" ? HARDHAT_LOCAL_CHAIN_ID : BSC_TESTNET_CHAIN_ID;
export const RPC_URL = BLOCKCHAIN_ENV === "local" ? HARDHAT_LOCAL_RPC : BSC_TESTNET_RPC;
export const NETWORK_NAME = BLOCKCHAIN_ENV === "local" ? "Hardhat Local" : "BSC Testnet";
