        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <div className="border-l-4 border-blue-500 pl-4">
              <p className="text-sm text-gray-600 mb-1">Tổng tiền hàng</p>
            ...
            <div className="border-l-4 border-red-500 pl-4">
              <p className="text-sm text-gray-600 mb-1">Tổng giảm giá</p>
              <p className="text-2xl font-bold text-red-600">
                -{formatCurrency(stats.revenue.discount)}
              </p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <p className="text-sm text-gray-600 mb-1">Doanh thu thực</p>
