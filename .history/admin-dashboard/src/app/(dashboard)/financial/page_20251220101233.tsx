...
import { AlertCircle, DollarSign, TrendingUp, Calendar, Download, Filter } from 'lucide-react'
...
export default function FinancialReportPage() {
  ...
  const { data: chartData, isLoading: chartLoading, error: chartError } = useRevenueChart(selectedPeriod)
  ...
  const calculateMetrics = () => {
    ...
    const { revenue } = stats
    const averageOrderValue = stats.orders.total > 0 ? revenue.total / stats.orders.total : 0
    const profitMargin = revenue.subtotal > 0 ? ((revenue.total - revenue.discount) / revenue.subtotal) * 100 : 0
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-white rounded-lg shadow border border-blue-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-gray-700">Tỷ suất lợi nhuận</h3>
