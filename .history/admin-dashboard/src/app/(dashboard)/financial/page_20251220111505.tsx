...
import { AlertCircle, DollarSign, Calendar, Download, Filter, ShoppingCart, TrendingUp, TrendingDown, Minus } from 'lucide-react'
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex rounded-lg bg-gray-100 p-1 text-sm font-medium">
            <button
              ...
              className={`px-3 py-1.5 rounded-md ${selectedPeriod === '7days' ? 'bg-white shadow text-gray-900' : 'text-gray-700'}`}
            >
              7 ngày
            </button>
            <button
              onClick={() => setSelectedPeriod('30days')}
              className={`px-3 py-1.5 rounded-md ${selectedPeriod === '30days' ? 'bg-white shadow text-gray-900' : 'text-gray-700'}`}
            >
              30 ngày
            </button>
            <button
              onClick={() => setSelectedPeriod('12months')}
              className={`px-3 py-1.5 rounded-md ${selectedPeriod === '12months' ? 'bg-white shadow text-gray-900' : 'text-gray-700'}`}
            >
              12 tháng
            </button>
          </div>
