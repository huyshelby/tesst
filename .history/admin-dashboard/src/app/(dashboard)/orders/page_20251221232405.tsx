          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              ...
              <div className="mt-3 p-3 bg-muted rounded-md text-sm">
                <div className="font-medium mb-1">Thông tin đơn hàng:</div>
                <div>Khách hàng: {orderToDelete?.customerName}</div>
                <div>Tổng tiền: {orderToDelete && formatOrderAmount(orderToDelete.total)}</div>
                <div>
                  Trạng thái:{' '}
                  {orderToDelete && getStatusBadge(orderToDelete.status).label}
                </div>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
