    ...
    if (promotion.type === 'PERCENTAGE') {
      return (
        <Badge variant="outline" className="text-blue-600 border-blue-300">
          ...
          {promotion.maxDiscount && ` (tối đa ${formatCurrencyCompactVN(promotion.maxDiscount)})`}
        </Badge>
      )
    }
    return (
      <Badge variant="outline" className="text-green-600 border-green-300">
        Giảm {formatCurrencyCompactVN(promotion.value)}
      </Badge>
    )
  }
                    ...
                    <div>
                      ...
                      {promotion.minOrderAmount && (
                        <p className="text-xs text-muted-foreground">
                          Đơn tối thiểu: {formatCurrencyCompactVN(promotion.minOrderAmount)}
                        </p>
                      )}
                    </div>
                  </TableCell>
