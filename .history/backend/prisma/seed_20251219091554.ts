...
const seedData = {
  ...
  products: [
    ...
    },
    {
      ...
      badges: ["Mới", "Còn hàng"],
      installment: true,
      specs: { storage: "256GB", cpu: "A19 Pro", screen: '6.9"' },
      categorySlug: "iphone",
    },
    // iPad - Từ phone-app mock
    {
      ...
      badges: ["Mới", "Trả góp 0%"],
      installment: true,
      specs: { storage: "256GB", chip: "M5", screen: '11"' },
      categorySlug: "tablet",
    },
    {
    ...
    // Mac - Từ phone-app mock
    {
      ...
      badges: ["Mới", "Trả góp 0%"],
      installment: true,
      specs: { ram: "16GB", storage: "512GB SSD", chip: "M5", screen: '14"' },
      categorySlug: "laptop",
    },
    {
      ...
      badges: ["Mới", "Còn hàng"],
      installment: true,
      specs: { ram: "16GB", storage: "256GB SSD", chip: "M4", screen: '13"' },
      categorySlug: "laptop",
    },
    {
      ...
      badges: ["Trả góp 0%", "Còn hàng"],
      installment: true,
      specs: { ram: "8GB", storage: "256GB SSD", chip: "M3", screen: '13"' },
      categorySlug: "laptop",
    },
    // Watch - Từ phone-app mock
    {
      ...
      badges: ["Mới", "Trả góp 0%"],
      installment: true,
      specs: { size: "49mm", connectivity: "GPS + Cellular" },
      categorySlug: "watch",
    },
    {
    ...
    },
    {
      ...
      installment: true,
      specs: { size: "40mm", material: "Nhôm" },
      categorySlug: "watch",
    },
    // Phụ kiện - Từ phone-app mock
    {
      name: "Magic Mouse 2",
      slug: "magic-mouse-2",
      ...
      badges: ["Còn hàng"],
      installment: false,
      specs: { color: "Trắng", connectivity: "Bluetooth" },
    ...
    },
    {
      ...
      badges: ["Còn hàng", "Trả góp 0%"],
      installment: true,
      specs: { compatibility: "iPad Pro 11 inch" },
      categorySlug: "accessory",
    },
    // Âm thanh - Từ phone-app mock
    {
      name: "AirPods Pro 3",
      slug: "airpods-pro-3",
    ...
    },
    {
      ...
      badges: ["Trả góp 0%", "Còn hàng"],
      installment: true,
      specs: { type: "Over-ear", port: "USB-C" },
      categorySlug: "audio",
    },
    {
      name: "AirPods 4",
    ...
    },
    {
      ...
      badges: ["Trả góp 0%", "Còn hàng"],
      installment: true,
      specs: { anc: "Có", port: "USB-C" },
      categorySlug: "audio",
    },
    // Thêm sản phẩm từ admin-dashboard mock data
    {
